...
const quadTextureDiffuse = await glance.loadTextureNow(gl, "./img/Wood_Diffuse.avif");
const quadTextureSpecular = await glance.loadTextureNow(gl, "./img/Wood_Specular.avif");
const quadTextureNormal = await glance.loadTextureNow(gl, "./img/Wood_Normal.avif");
const quadTextureDepth = await glance.loadTextureNow(gl, "./img/Wood_Depth.avif");
