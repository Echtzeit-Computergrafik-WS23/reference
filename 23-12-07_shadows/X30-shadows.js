...
const lightProjection = mat4.ortho(-1.43, 1.43, -0.55, 0.55, -0.3, 2.2);
...
const torusTubularSegments = 128;
const torusRadialSegments = 32;
...
const torusABO = glance.createAttributeBuffer(gl, "torus-abo", glance.createTorusKnotAttributes({
    radius: 0.1,
    tube: 0.035,
    tubularSegments: torusTubularSegments,
    radialSegments: torusRadialSegments,
    p: 2,
    q: 3,
    tangents: true,
}), {
