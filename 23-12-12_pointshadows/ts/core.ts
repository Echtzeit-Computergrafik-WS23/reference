    ...
    try {
        ...
        if (depth === null) {
            ...
            if (options.compareFunc ?? TextureCompareFunc.NONE !== TextureCompareFunc.NONE) {
                ...
                gl.texParameteri(target, gl.TEXTURE_COMPARE_FUNC, options.compareFunc as number);
            }
        }
...
function isFramebufferAttachment(obj: any): obj is FramebufferAttachment
{
...
function createFramebuffer(
    gl: WebGL2,
    name: string,
    color: AttachmentDefinition | Array<AttachmentDefinition> | FramebufferAttachment | Array<FramebufferAttachment> | null = null,
    ...
    try {
        ...
        if (colorAttachments.length === 0) {
            ...
            for (let i = 0; i < colorAttachments.length; ++i) {
                ...
                if (color.attachment.attachmentType == AttachmentType.TEXTURE) {
                    const texture = color.attachment as Texture;
                ...
                // Color attachment is a Renderbuffer
                    ...
                    const renderbuffer = color.attachment as Renderbuffer;
        ...
        if (depthAttachment !== null) {
            ...
            if (depthAttachment.attachment.attachmentType === AttachmentType.TEXTURE) {
                const texture = depthAttachment.attachment as Texture;
            ...
            // Depth attachment is a Renderbuffer
                ...
                const renderbuffer = depthAttachment.attachment as Renderbuffer;
 ...
 */
function attributeToGLSLType(attr: AttributeDescription): GlslAttributeDataType
{
    switch (attr.type) {
        case AttributeDataType.BYTE:
        case AttributeDataType.SHORT:
...
function createDrawCall(
    ...
    options: {
        ...
        indexCount?: number,
        indexOffset?: number,
        instanceCount?: number, // TODO: rename to `instances`
