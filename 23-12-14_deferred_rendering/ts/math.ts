...
// TODO: https://en.wikipedia.org/wiki/Rodrigues'_rotation_formula
//      ... How have I not heard about this one before?
//      See https://www.youtube.com/watch?v=khblXafu7iA, around 20:23
...
const vec3 = {
    ...
    subtract: (out: Vec3, v: Vec3): Vec3 => { out[0] -= v[0]; out[1] -= v[1]; out[2] -= v[2]; return out; }, // TODO: rename to sub, mul, div etc.
...
const mat4 = {
    ...
    fromScaling: (v: Vec3 | number): Mat4 =>
    {
        if (Array.isArray(v)) {
            return [
                v[0], 0, 0, 0,
